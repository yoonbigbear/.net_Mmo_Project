...
public struct StateSync : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_22_9_29(); }
  public static StateSync GetRootAsStateSync(ByteBuffer _bb) { return GetRootAsStateSync(_bb, new StateSync()); }
  public static StateSync GetRootAsStateSync(ByteBuffer _bb, StateSync obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public StateSync __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<StateSync> CreateStateSync(FlatBufferBuilder builder,
      uint obj_id = 0,
      VectorOffset keysOffset = default(VectorOffset),
      VectorOffset valuesOffset = default(VectorOffset)) {
    builder.StartTable(3);
    StateSync.AddValues(builder, valuesOffset);
    StateSync.AddKeys(builder, keysOffset);
    StateSync.AddObjId(builder, obj_id);
    return StateSync.EndStateSync(builder);
  }

  public static void StartStateSync(FlatBufferBuilder builder) { builder.StartTable(3); }
  ...
  public static Offset<StateSync> EndStateSync(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<StateSync>(o);
  }
  public StateSyncT UnPack() {
    var _o = new StateSyncT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(StateSyncT _o) {
    _o.ObjId = this.ObjId;
  ...
  public static Offset<StateSync> Pack(FlatBufferBuilder builder, StateSyncT _o) {
    if (_o == null) return default(Offset<StateSync>);
