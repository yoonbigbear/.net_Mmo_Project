...
public struct AddItemResp : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_22_9_29(); }
  public static AddItemResp GetRootAsAddItemResp(ByteBuffer _bb) { return GetRootAsAddItemResp(_bb, new AddItemResp()); }
  public static AddItemResp GetRootAsAddItemResp(ByteBuffer _bb, AddItemResp obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AddItemResp __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<AddItemResp> CreateAddItemResp(FlatBufferBuilder builder,
      VectorOffset itemsOffset = default(VectorOffset),
      ErrorCode error_code = ErrorCode.Success) {
    builder.StartTable(2);
    AddItemResp.AddItems(builder, itemsOffset);
    AddItemResp.AddErrorCode(builder, error_code);
    return AddItemResp.EndAddItemResp(builder);
  }

  public static void StartAddItemResp(FlatBufferBuilder builder) { builder.StartTable(2); }
  ...
  public static Offset<AddItemResp> EndAddItemResp(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AddItemResp>(o);
  }
  public AddItemRespT UnPack() {
    var _o = new AddItemRespT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AddItemRespT _o) {
  ...
  public static Offset<AddItemResp> Pack(FlatBufferBuilder builder, AddItemRespT _o) {
    if (_o == null) return default(Offset<AddItemResp>);
